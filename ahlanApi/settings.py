...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000", # Qo‘shimcha ehtiyot uchun
]

# Agar barcha origin’larga ruxsat bermoqchi bo‘lsangiz (tavsiya etilmaydi):
# CORS_ALLOW_ALL_ORIGINS = True

# POST so‘rovlari uchun qo‘shimcha ruxsatlar
CORS_ALLOW_METHODS = [
    "DELETE",
    "GET",
    "OPTIONS",
